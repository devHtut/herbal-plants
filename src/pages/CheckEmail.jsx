...
export default function CheckEmail() {
  ...
  // Optional: auto timeout for any user who leaves it too long
  useEffect(() => {
    ...
    <div className="min-h-screen bg-[#F2F2F7] flex flex-col font-sans">
      ...
      <div className="flex-1 flex flex-col items-center px-8 pt-16">
        ...
        <p className="text-gray-600 text-[16px] text-center mb-8 leading-relaxed">
          ကျနော်တို့ confirmation link ကို<br />
        ...
        <button
          ...
          className="mt-8 text-[#007AFF] font-semibold text-[17px] active:opacity-50"
        >
          Open Gmail
        </button>
      </div>
